...
class LikeButton extends StatefulWidget {
  ...
  const LikeButton({
    ...
    this.dotColor = const DotColor(
      dotPrimaryColor: const Color(0xFF80D8FF),
      dotSecondaryColor: const Color(0xFF40C4FF),
      dotThirdColor: const Color(0xFF00B0FF),
      dotLastColor: const Color(0xFF0091EA),
    ),
    this.circleStartColor = const Color(0xFF2979FF),
    this.circleEndColor = const Color(0xFF80D8FF),
    this.onIconClicked,
  }) : super(key: key);
